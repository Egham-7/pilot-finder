                ...
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  >
                    <span className="text-foreground text-sm">
                      Now Scanning 50+ Platforms for Customer Complaints
                    </span>
                  ...
                  <p className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                    AI agents that find people complaining about your problem
                    across the internet—or tell you the hard truth about why you
                    need to pivot.
                  </p>
                </AnimatedGroup>
...
const Logo = ({ className }: { className?: string }) => {
  return (
    <svg
      ...
      aria-label="PilotFinder Logo"
    >
      <title>PilotFinder</title>
      <path
